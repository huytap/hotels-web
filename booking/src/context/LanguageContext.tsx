...
const staticTexts = {
  vi: {
    ...
    'subtotal': 'Tạm tính',
    'before_tax': 'Chưa bao gồm thuế',
    'service_charge': 'Phí dịch vụ',
    'prices_include_tax_note': '* Giá đã bao gồm VAT và phí dịch vụ',
    // Promotion & Room Card
    ...
    // Tracking page
    'track_booking': 'Tra Cứu Đặt Phòng',
    'tracking.title': 'Tra Cứu Đặt Phòng',
    'track_description': 'Nhập mã đặt phòng hoặc email để tra cứu thông tin đặt phòng của bạn',
    'search_by': 'Tra cứu bằng',
    'booking_number': 'Mã Đặt Phòng',
    'email': 'Email',
    'enter_booking_number': 'VD: BK20251001123456',
    'enter_email': 'VD: example@email.com',
    'search': 'Tìm Kiếm',
    'searching': 'Đang tìm...',
    'booking': 'Đặt Phòng',
    'booked_on': 'Đặt lúc',
    ...
    'cancel_warning': 'Bạn có chắc chắn muốn hủy đặt phòng này? Hành động này không thể hoàn tác.',
    'cancel_reason': 'Vui lòng nhập lý do hủy...',
    'cancelling': 'Đang hủy...',
    'yes_cancel': 'Có, Hủy Đặt Phòng',
    'no_keep': 'Không, Giữ Lại',
    'status_pending': 'Đang Chờ',
    'status_confirmed': 'Đã Xác Nhận',
    'status_cancelled': 'Đã Hủy',
    'status_completed': 'Hoàn Thành',
    'status_no_show': 'Không Đến',
    'please_enter_search': 'Vui lòng nhập mã đặt phòng hoặc email',
    'booking_not_found': 'Không tìm thấy đặt phòng. Vui lòng kiểm tra lại mã đặt phòng hoặc email.',
    'error_occurred': 'Có lỗi xảy ra. Vui lòng thử lại.',
    'cancel_reason_required': 'Vui lòng nhập lý do hủy',
    'booking_cancelled': 'Đặt phòng đã được hủy thành công',
    'cancel_error': 'Không thể hủy đặt phòng. Vui lòng liên hệ bộ phận hỗ trợ.',
    'hotel_not_configured': 'Không tìm thấy cấu hình khách sạn'
  },
  en: {
    ...
    'prices_include_tax_note': '* Prices include VAT and service charge',
    // Promotion & Room Card
    ...
    'tracking.title': 'Track Your Booking',
    'track_description': 'Enter your booking number or email to track your reservation',
    'search_by': 'Search by',
    'booking_number': 'Booking Number',
    'email': 'Email',
    'enter_booking_number': 'e.g., BK20251001123456',
    'enter_email': 'e.g., example@email.com',
    'search': 'Search',
    'searching': 'Searching...',
    'booking': 'Booking',
    'booked_on': 'Booked on',
    ...
    'cancel_warning': 'Are you sure you want to cancel this booking? This action cannot be undone.',
    ...
    'please_enter_search': 'Please enter booking number or email',
    'booking_not_found': 'Booking not found. Please check your booking number or email.',
    'error_occurred': 'An error occurred. Please try again.',
    'cancel_reason_required': 'Please provide a reason for cancellation',
    'booking_cancelled': 'Booking has been cancelled successfully',
    'cancel_error': 'Failed to cancel booking. Please contact support.',
    'hotel_not_configured': 'Hotel configuration not found'
  },
  ko: {
